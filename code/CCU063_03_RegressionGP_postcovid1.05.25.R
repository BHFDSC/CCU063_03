...
##save mv_tab_base
write.csv(univ_tab_base, "/CCU063_03/GPuniregression_postcovid.24.05.csv", row.names = FALSE)

write.csv(mv_tab_base, "/CCU063_03/GPmultiregression_postcovid.24.05.csv", row.names = FALSE)

write.csv(mv_tab_base1, "/CCU063_03/GPmultiregressionwoethnicity_postcovid.24.05.csv", row.names = FALSE)
