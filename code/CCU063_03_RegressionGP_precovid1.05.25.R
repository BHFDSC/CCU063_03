...
##Limit to participants with preconception period pre-COVID
...
##save mv_tab_base
write.csv(univ_tab_base, "/CCU063_03/GPuniregression_precovid.24.05.csv", row.names = FALSE)

write.csv(mv_tab_base, "/CCU063_03/GPmultiregression_precovid.24.05.csv", row.names = FALSE)

write.csv(mv_tab_base1, "/CCU063_03/GPmultiregressionwoethnicity_precovid.24.05.csv", row.names = FALSE)
