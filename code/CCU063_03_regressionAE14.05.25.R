...
##Save tables
write.csv(univ_tab_base_ae, "/CCU063_03/AEuniregression.24.05.csv", row.names = FALSE)

write.csv(mv_tab_base_ae, "/CCU063_03/AEmultiregression.24.05.csv", row.names = FALSE)

write.csv(mv_tab_base1_ae, "/CCU063_03/AEmultiregressionwithoutethnicity.24.05.csv", row.names = FALSE)
