...
#Save table
write.csv(table, "/CCU063_03/table1_duringCOVID.25.05.csv", row.names = FALSE)
...
#Save table
write.csv(final_summary, "/CCU063_03/medianage_duringcovid.24.05.csv", row.names = FALSE)
