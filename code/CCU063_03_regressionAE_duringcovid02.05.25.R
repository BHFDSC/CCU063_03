...
##Save tables
write.csv(univ_tab_base_ae, "/CCU063_03/AEuniregression_duringcovid.24.05.csv", row.names = FALSE)

write.csv(mv_tab_base_ae, "/CCU063_03/AEmultiregression_duringcovid.24.05.csv", row.names = FALSE)

write.csv(mv_tab_base1_ae, "/CCU063_03/AEmultiregression2_duringcovid.24.05.csv", row.names = FALSE)
