...
mydata2 <- mydata2 %>%
  filter(covid_period_applicable == "during")
...
##save mv_tab_base
write.csv(univ_tab_base, "/CCU063_03/GPuniregression_duringcovid.24.05.csv", row.names = FALSE)

write.csv(mv_tab_base, "/CCU063_03/GPmultiregression_duringcovid.24.05.csv", row.names = FALSE)

write.csv(mv_tab_base1, "/CCU063_03/GPmultiregressionwoethnicity_duringcovid.24.05.csv", row.names = FALSE)
